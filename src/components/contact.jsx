    ...
    return (
        <Box id='contact'>
            ...
            <Typography variant='h1' sx={{
                typography: { xs: 'h4', sm: 'h3', md: 'h2', lg: 'h2', xl: 'h1' },
            ...
            <Grid container>
                ...
                <Grid size={{ xs: 12, sm: 12, md: 6, lg: 6, xl: 6 }} display={{ xs: "none", sm: 'none', md: 'block', lg: "block", xl: 'block' }}>
                    <Card sx={{ height: '100%' }} elevation={0}>
                        <CardMedia component="img"
                            sx={{ padding: 5, display: 'block', marginLeft: 0, width: "70%", borderRadius: 3 }}
                            image={svg} alt="Programming Gif">
                        </CardMedia>
                    </Card>
                </Grid>
